...
export const ABOUT_ROUTES: Routes = [
  ...
  },
  {
    path: 'donacije',
    loadComponent: () =>
      import('./components/donate-page/donate-page.component').then((m) => m.DonatePageComponent),
    pathMatch: 'full'
  },
  ...
  { path: 'terms', redirectTo: 'pogoji', pathMatch: 'full' },
  {
    path: 'licenca',
    loadComponent: () =>
      import('./components/license-page/license-page.component').then(
        (m) => m.LicensePageComponent
      ),
    pathMatch: 'full'
  },
